...
public class PlumberActivity extends AppCompatActivity {
    private final String[][] plumber_detail =
            {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.plumberactivity);

        list = new ArrayList<>();
        for (String[] detail : plumber_detail) {
            item = new HashMap<>();
        ...
        list1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long id) {
                Intent it = new Intent(PlumberActivity.this, BookActivity.class);
                it.putExtra("text1", plumber_detail[i][0]);
                it.putExtra("text2",plumber_detail[i][3]);
                it.putExtra("text3",plumber_detail[i][4]);
                startActivity(it);
            }
        });
