...
public class HomeCleaningActivity extends AppCompatActivity {
    private final String[][] home_cleaning_detail =
            {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        for (String[] detail : home_cleaning_detail) {
            item = new HashMap<>();
        ...
        list1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long id) {
                Intent it = new Intent(HomeCleaningActivity.this, BookActivity.class);
                it.putExtra("text1", home_cleaning_detail[i][0]);
                it.putExtra("text2",home_cleaning_detail[i][3]);
                it.putExtra("text3",home_cleaning_detail[i][4]);
                startActivity(it);
            }
        });
    }
