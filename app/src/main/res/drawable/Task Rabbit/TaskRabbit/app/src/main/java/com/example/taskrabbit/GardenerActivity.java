...
public class GardenerActivity extends AppCompatActivity {
    private final String[][] gardener_detail =
            {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        for (String[] detail : gardener_detail) {
            item = new HashMap<>();
        ...
        list1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long id) {
                Intent it = new Intent(GardenerActivity.this, BookActivity.class);
                it.putExtra("text1", gardener_detail[i][0]);
                it.putExtra("text2",gardener_detail[i][3]);
                it.putExtra("text3",gardener_detail[i][4]);
                startActivity(it);
            }
        });
    }
