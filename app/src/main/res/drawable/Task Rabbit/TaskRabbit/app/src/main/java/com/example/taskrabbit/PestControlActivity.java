...
public class PestControlActivity extends AppCompatActivity {
    private final String[][] pest_control_detail =
            {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        for (String[] detail : pest_control_detail) {
            item = new HashMap<>();
        ...
        list1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long id) {
                Intent it = new Intent(PestControlActivity.this, BookActivity.class);
                it.putExtra("text1", pest_control_detail[i][0]);
                it.putExtra("text2",pest_control_detail[i][3]);
                it.putExtra("text3",pest_control_detail[i][4]);
                startActivity(it);
            }
        });
    }
