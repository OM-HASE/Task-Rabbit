...
public class ElectricianActivity extends AppCompatActivity {
    private final String[][] electrician_detail =
            {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.electricianactivity);

        list = new ArrayList<>();
        for (String[] detail : electrician_detail) {
            item = new HashMap<>();
        ...
        list1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long id) {
                Intent it = new Intent(ElectricianActivity.this, BookActivity.class);
                it.putExtra("text1", electrician_detail[i][0]);
                it.putExtra("text2",electrician_detail[i][3]);
                it.putExtra("text3",electrician_detail[i][4]);
                startActivity(it);
            }
        });
    }
